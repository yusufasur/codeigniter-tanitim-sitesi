                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form action="<?= linkto('admin/menuekleto') ?>" method="post" class="form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <label>
                                            <div class="radio"><span><input type="radio" name="tur" value="0" onclick="linkok()" style="opacity: 0;"></span></div>
                                            Link Yönlendirme</label>
                                        <?php if ($sayfalar): ?>
                                        <label>
                                            <div class="radio"><span><input type="radio" name="tur" value="1" onclick="sayfaok()" style="opacity: 0;"></span></div>
                                            Sayfa Seçme</label>
                                        <?php endif; ?>
                                    </div>
                                </div>
